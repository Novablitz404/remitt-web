    ...
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative flex max-w-xl flex-col items-start px-6 py-16 text-left sm:px-10 lg:px-20">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          <a
            href="https://x.com/remitt_app"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 rounded-full border border-white/40 bg-white/10 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-ink/30 backdrop-blur-sm transition-colors hover:bg-white/20"
          >
            {/* X logo */}
